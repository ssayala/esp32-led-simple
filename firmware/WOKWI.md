...
| MAX7219 display + scrolling | ✅ | 4 chained modules via the `chain` attr; `"layout": "fc16"` matches the FC16 hardware (`HARDWARE_TYPE` = `FC16_HW`) — omit it and columns render scrambled |
